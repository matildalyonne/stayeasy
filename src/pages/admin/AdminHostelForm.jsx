...
export default function AdminHostelForm() {
  ...
  const handleFileUpload = async (e) => {
    ...
    const { data, error } = await supabase.storage.from('hostel-images').upload(path, file, { upsert: true })
    if (error) {
        ...
        <section className={styles.section}>
          ...
          <div className={styles.grid2}>
            <Input
              label="Hostel Name *"
              name="name"
              placeholder="e.g. Makerere View Hostel"
              value={form.name}
          ...
          <div className={styles.field}>
            ...
            <textarea
              ...
              placeholder="Describe the hostel, its environment, and what makes it special…"
        ...
        <section className={styles.section}>
          ...
          <div className={styles.uploadWrap}>
            <label className={styles.uploadLabel}>
              ...
              <input type="file" accept="image/*" onChange={handleFileUpload} className={styles.srOnly} disabled={uploading} />
            </label>
          </div>
